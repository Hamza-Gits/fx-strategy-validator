//+------------------------------------------------------------------+
//|                                            NDCB_XAU_v1_1.mq5     |
//|     XAUUSD H1 — NY Data-Hour Compression Breakout (NDCB) v1.1    |
//|                                                                  |
//|  v1.1 BUG FIX (over v1.0 — Backtest 3 disaster):                 |
...
//+------------------------------------------------------------------+
#property copyright "NDCB-XAU EA v1.1 — bar-close trigger fix"
...
int OnInit()
{
   gv_prefix = "NDCB11_" + _Symbol + "_";   // v1.1 prefix — avoid stale v1.0 state
   ...
   LogInfo(StringFormat("NDCB-XAU v1.1 Init | %s | State=%s | bar-close trigger", _Symbol, StateName(g_state)));
